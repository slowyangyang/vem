   ...
   <!-- // map -->
    ...
    <div class="control">
      <van-row type="flex" justify="space-between" align="center" gutter="10">
        ...
        <!-- <van-col :span="2"><van-icon name="arrow-left" :size="20" @click="changeSpeed('less')"/></van-col> -->
        <van-col :span="15"><van-slider v-model="sliderVal" button-size="20"  @change="onChange" @input="onInput"/></van-col>
        <!-- <van-col :span="1"><van-icon name="arrow" :size="20" @click="changeSpeed('add')"/></van-col> -->
...
data(){
  ...
  methods:{
    ...
    changeSpeed(e) {
      ...
      //     this.times *= base;
      //   }
      //     this.$Toast({message:'x'+this.times,duration:500})
